...
document.querySelector('.div-12').onmousedown = f1;
...
document.querySelector('.div-13').onmousedown = h1;
document.querySelector('.div-13').onmouseup=  h2;
...
function t18(event) {
    ...
    event.target.innerHTML = event.target.clientWidth
}
