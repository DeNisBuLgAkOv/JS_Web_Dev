...
function f6() {
    let i = document.querySelector('.i-61').value;
...
function f19() {
    ...
    let newStr = inp[0].toUpperCase() + inp.slice(1).toLowerCase()
    console.log(inp.slice(1))
   
    for(let val in a19 ){
      
        for(let i=0; i < a19[val].length; i++){
           if( a19[val][i] == newStr ){
                print = val
                console.log(print)
           }
    ...
    document.querySelector('.out-19').innerHTML =print
