...
let ar4 =  ['Ivan', 45,76, true, 56, false, 1, -5, 'hello', 100, 200]
...
function f10() {
    document.querySelector('.out-10').innerHTML = ar10[ar9.length-1] + ar10[0];
}
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML =print;
...
function f13() {
   ...
   document.querySelector('.out-13').innerHTML =print;
}
...
function f14() {    
    ...
    document.querySelector('.out-14').innerHTML =print;    
...
function f15() {
    ...
    for(let i = 0; i < ar15.length; i++){
        console.log(ar15.length)
        if(ar15[i] >0){
            print +=  ar15[i] +' ';
        }
    }
    document.querySelector('.out-15').innerHTML =print;    
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML =col;   
}
