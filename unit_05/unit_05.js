...
function t1() {
    ...
    document.querySelector('.out-1').innerHTML = print;
}
...
function t2() {
    ...
    document.querySelector('.out-2').innerHTML = print;
}
...
function t3() {
    ...
    document.querySelector('.out-3').innerHTML = print;
}
...
function t4() {
    ...
    document.querySelector('.out-4').innerHTML = print;
}
...
function t5() {
    ...
    document.querySelector('.out-5').innerHTML = print;
}
...
function t6() {
    let kol = +document.querySelector('.i-6').value;
    let print ='';
    for(let i =0; i < kol; i++){
        print +='******'+ '<br/>'
    }
    document.querySelector('.out-6').innerHTML = print;
}
...
function t8() {
    let num = +document.querySelector('.i-81').value;
    let numMore =+document.querySelector('.i-82').value;
    let print ='';
    for(let i = num; i <= numMore; i++){
        print += i +'_';
    }
...
function t9() {
    let num = +document.querySelector('.i-91').value;
    let num1 =+document.querySelector('.i-92').value;
    let print ='';
    if(num > num1){
...
function t11() {
    ...
    for(let i =0; i< divs.length; i++){
        out.innerHTML +=divs[i].textContent + '<br/>'
    }
