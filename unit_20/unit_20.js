...
function t6(event) {
    ...
    document.querySelector('.i-6').value = inp
    return false;
}
...
function t7() {
    document.querySelector('.out-7').innerHTML = a7[Math.floor(Math.random() * (a7.length-1))]
...
function t9(event) {
    ...
    document.querySelector('.out-9').innerHTML = kol
}
...
*/
let but = document.querySelectorAll('.keyboard')
function t11(event) {
    console.log(event)
