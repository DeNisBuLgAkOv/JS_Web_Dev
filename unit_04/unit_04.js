...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = inp;
}
...
function f8() {
    document.querySelector('.out-8') .innerHTML = '<div class="js-2">new div</div>'
}
...
function f11() {
    ...
    let colorNew =document.querySelector('.i-112');
    colorNew.value = color.value;
...
function f15() {
    ...
    document.querySelector('.out-15').innerHTML = inp;
    document.querySelector('.t-15').innerHTML = inp;
}
...
function f16() {
    ...
    let opt = document.querySelector('.s-16').value;
    document.querySelector('.out-16').innerHTML = opt
}
...
function f17() {
    let opt = document.querySelector('.s-17').value;
    document.querySelector('.out-17').innerHTML = opt
}
...
function f18() {
    let opt = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = opt
}
...
function f20() {
    ...
    let sel2 =document.querySelector('.s-202');
