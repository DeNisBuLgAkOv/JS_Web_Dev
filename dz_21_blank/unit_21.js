...
function t2(event) {
    kol2++
    document.querySelector('.out-2').innerHTML = kol2
...
function t8() {
    this.style.background = a8[Math.floor(Math.random() * (a8.length-1))]
...
function t9(e) {
	...
	out9.innerHTML = e.touches.length
}
...
function t11(event) {
    console.log(event)
    let radX = event.targetTouches[0].radiusX;
	let radY = event.targetTouches[0].radiusY;
	document.querySelector('.out-11').innerHTML = radX + ' ' + radY;
}
