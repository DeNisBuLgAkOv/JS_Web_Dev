...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Denis')
        .then(data =>data.text())
        .then(data =>out('.out-2',data) )
}
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=3&num2=5')
        .then(data =>data.text())
        .then(data =>out('.out-3',data) )
}
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=1&num2=5')
        .then(data =>data.text())
        .then(data =>out('.out-4',data) )
}
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=1&num2=8')
        .then(data =>data.text())
        .then(data =>out('.out-6',data) )
}
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1999')
        .then(data =>data.text())
        .then(data =>out('.out-8',data) )
}
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=2&name=Denis'
      })
      .then(data => data.text())
      .then(data => out('.out-11',data))
}
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=3&num1=2&num2=7'
      })
      .then(data => data.text())
      .then(data => out('.out-12',data))
}
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=6&num1=1&num2=9'
      })
      .then(data => data.text())
      .then(data => out('.out-15',data))
}
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=8&year=1999'
      })
      .then(data => data.text())
      .then(data => out('.out-17',data))
}
